...
@synthesize apositiveHorizontalMagnitude = _apositiveHorizontalMagnitude;
@synthesize anegativeHorizontalMagnitude = _anegativeHorizontalMagnitude;
@synthesize apositiveVerticalMagnitude = _apositiveVerticalMagnitude;
@synthesize anegativeVerticalMagnitude = _anegativeVerticalMagnitude;
@synthesize apositiveHorizontalCategory = _apositiveHorizontalCategory;
@synthesize anegativeHorizontalCategory = _anegativeHorizontalCategory;
@synthesize apositiveVerticalCategory = _apositiveVerticalCategory;
@synthesize anegativeVerticalCategory = _anegativeVerticalCategory;
@synthesize ahorizontalComponentForPositiveVertical = _ahorizontalComponentForPositiveVertical;
@synthesize ahorizontalComponentForNegativeVertical = _ahorizontalComponentForNegativeVertical;

@synthesize bpositiveHorizontalMagnitude = _bpositiveHorizontalMagnitude;
@synthesize bnegativeHorizontalMagnitude = _bnegativeHorizontalMagnitude;
@synthesize bpositiveVerticalMagnitude = _bpositiveVerticalMagnitude;
@synthesize bnegativeVerticalMagnitude = _bnegativeVerticalMagnitude;
@synthesize bpositiveHorizontalCategory = _bpositiveHorizontalCategory;
@synthesize bnegativeHorizontalCategory = _bnegativeHorizontalCategory;
@synthesize bpositiveVerticalCategory = _bpositiveVerticalCategory;
@synthesize bnegativeVerticalCategory = _bnegativeVerticalCategory;
@synthesize bhorizontalComponentForPositiveVertical = _bhorizontalComponentForPositiveVertical;
@synthesize bhorizontalComponentForNegativeVertical = _bhorizontalComponentForNegativeVertical;
...
-(void) simulateAnalysisValues
{
    ...
    for( i = 0; i < 6; i++ ) {
        ...
        [[self.pathObject.pathBins objectAtIndex:i] setPositiveHorizontalCategory:self.apositiveHorizontalCategory];
        [[self.pathObject.pathBins objectAtIndex:i] setPositiveHorizontalMagnitude:self.apositiveHorizontalMagnitude];
        
        [[self.pathObject.pathBins objectAtIndex:i] setNegativeHorizontalCategory:self.anegativeHorizontalCategory];
        [[self.pathObject.pathBins objectAtIndex:i] setNegativeHorizontalMagnitude:self.anegativeHorizontalMagnitude];
        
        [[self.pathObject.pathBins objectAtIndex:i] setPositiveVerticalCategory:self.apositiveVerticalCategory];
        [[self.pathObject.pathBins objectAtIndex:i] setPositiveVerticalMagnitude:self.apositiveVerticalMagnitude];
        
        [[self.pathObject.pathBins objectAtIndex:i] setNegativeVerticalCategory:self.anegativeVerticalCategory];
        [[self.pathObject.pathBins objectAtIndex:i] setNegativeVerticalMagnitude:self.anegativeVerticalMagnitude];
        
        [[self.pathObject.pathBins objectAtIndex:i] setHorizontalComponentForNegativeVertical:self.ahorizontalComponentForNegativeVertical];
        [[self.pathObject.pathBins objectAtIndex:i] setHorizontalComponentForPositiveVertical:self.ahorizontalComponentForPositiveVertical];
    }
    for( i = 6; i < 13; i++ ) {
        
        [[self.pathObject.pathBins objectAtIndex:i] setPositiveHorizontalCategory:self.bpositiveHorizontalCategory];
        [[self.pathObject.pathBins objectAtIndex:i] setPositiveHorizontalMagnitude:self.bpositiveHorizontalMagnitude];
        
        [[self.pathObject.pathBins objectAtIndex:i] setNegativeHorizontalCategory:self.bnegativeHorizontalCategory];
        [[self.pathObject.pathBins objectAtIndex:i] setNegativeHorizontalMagnitude:self.bnegativeHorizontalMagnitude];
        
        [[self.pathObject.pathBins objectAtIndex:i] setPositiveVerticalCategory:self.bpositiveVerticalCategory];
        [[self.pathObject.pathBins objectAtIndex:i] setPositiveVerticalMagnitude:self.bpositiveVerticalMagnitude];
        
        [[self.pathObject.pathBins objectAtIndex:i] setNegativeVerticalCategory:self.bnegativeVerticalCategory];
        [[self.pathObject.pathBins objectAtIndex:i] setNegativeVerticalMagnitude:self.bnegativeVerticalMagnitude];
        
        [[self.pathObject.pathBins objectAtIndex:i] setHorizontalComponentForNegativeVertical:self.bhorizontalComponentForNegativeVertical];
        [[self.pathObject.pathBins objectAtIndex:i] setHorizontalComponentForPositiveVertical:self.bhorizontalComponentForPositiveVertical];
    }
    for( i = 13; i < 20; i++ ) {
