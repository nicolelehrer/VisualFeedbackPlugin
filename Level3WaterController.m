...
//        self.numSheets = 10; //for 2 islands
        self.numSheets = 20;
...
{
    self.waterSheet = [WaterSheet createWithName:@"level3Water" parent:[Dash root] withGridDimsX:300 andY:70 withShaderName:@"WavesLevel3"];
...
-(void) drawDayWater
{
    ...
    self.waterSheet.colorFactor = 0.0;

    self.waterSheet.seg = 2.0;
    self.waterSheet.ampX = 3.5;
    self.waterSheet.ampY = 2.631579;
    self.waterSheet.freqX = -26.875;
    self.waterSheet.freqY = .1855;
    
    self.waterSheet.useColor = 0.0;

    self.waterSheet.timeFactorX = 1.2;
...
-(void) drawGreyWater
{
    ...
    {     
        ...
        self.waterSheet.transX = 0; 
        self.waterSheet.transY = self.initialWaterDepth + self.waterSheetDepthOverlap*i + self.displacementDepth - 190.0;
        //last subdtraction added because added rotation like severe
...
-(void) drawStormyWater
{
    ...
    */
    ...
    self.waterSheet.useColor = 2.0;

    self.waterSheet.vecCalcType = 0.0;
//    self.waterSheet.colorFactor = 2;

    //lo's changes
    self.waterSheet.timeFactorX = 1.0;
    self.waterSheet.ampX = 8;
    
//    self.waterSheet.timeFactorX = 16.0;
...
//        self.waterSheet.transY = self.initialWaterDepth +2600*i + self.displacementDepth;
        self.waterSheet.transY = self.initialWaterDepth + self.waterSheetDepthOverlap*i + self.displacementDepth - 190.0;
        //last subtraction is tp avoid seeing end of sheet on the bottom of screen
